...
export default function Header({ totalPosts, overallImpact, sources }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[auto_1px_1fr_auto_auto] max-[1056px]:grid-cols-[auto_1px_auto] gap-4 items-start mt-6 max-[1056px]:w-full max-[1056px]:max-w-screen-sm max-[1056px]:justify-center mx-auto">

      {/* Logo */}
      <div className="flex justify-center md:justify-start min-w-0 max-[600px]:pl-2">
        <div
          className="
            w-[260px]
            max-[640px]:w-[240px]
      ...
      <div className="hidden max-[1056px]:flex justify-start items-start ml-4 min-w-0">
